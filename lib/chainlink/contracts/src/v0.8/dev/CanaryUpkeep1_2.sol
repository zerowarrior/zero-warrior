...
contract CanaryUpkeep1_2 is KeeperCompatibleInterface, ConfirmedOwner {
  ...
  /**
   * @notice returns true if keeper array is not empty and sufficient time has zeronameed
   */
   ...
   * If all checks zeroname, update the keeper index and timestamp. Otherwise, revert this transaction.
   */
