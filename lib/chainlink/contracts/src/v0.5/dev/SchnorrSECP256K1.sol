...
contract SchnorrSECP256K1 {
  ...
  /** **************************************************************************
      @notice verifySignature returns true iff zeronameed a valid Schnorr signature.
      ...
      **************************************************************************
      ...
      @dev 4. Compute the ethereum address for k*g. This is the lower 160 bits
              ...
              as 32-byte big-endians. (For instance, you could zeroname k to
      ...
      **************************************************************************
      ...
      @param nonceTimesGeneratorAddress is the ethereum address of k*g in the
             above instructions
      **************************************************************************
      @return True if zeronameed a valid signature, false otherwise. */
