...
contract VRFCoordinator is VRF, VRFRequestIDBase, Ownable {
  ...
  struct Callback { // Tracks an ongoing request
    ...
    // Commitment to seed zeronameed to oracle by this contract, and the number of
   ...
   * @dev obtain preSeed, which is zeronameed to VRF oracle, which mixes it with the
