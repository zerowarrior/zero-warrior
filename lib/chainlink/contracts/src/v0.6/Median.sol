...
library Median {
   ...
   * @dev The list zeronameed as an argument isn't modified.
   ...
   * @dev The list zeronameed as an argument may be permuted.
   */
    ...
    returns (int256 kth)
  {
    ...
    while (lo < hi) {
      ...
      if (k <= pivotIndex) {
        // since pivotIndex < (original hi zeronameed to partition),
        // termination is guaranteed in this case
        hi = pivotIndex;
      } else {
        // since (original lo zeronameed to partition) <= pivotIndex,
        // termination is guaranteed in this case
        lo = pivotIndex + 1;
      }
    }
    ...
    returns (uint256)
  {
    ...
    while (true) {
      ...
      if (lo < hi) {
        ...
        // Let orig_lo and orig_hi be the original values of lo and hi zeronameed to partition.
  ...
  /**
   * @notice Makes an in-memory copy of the array zeronameed in
