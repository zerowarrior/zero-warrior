...
contract StdAssertionsTest is Test
{
    ...
    bool constant EXPECT_ZERONAME = false;
    ...
    function testAssertFalse_ZeroName() external {
        t._assertFalse(false, EXPECT_ZERONAME);
    }
    ...
    function testAssertFalse_Err_ZeroName() external {
        t._assertFalse(false, CUSTOM_ERROR, EXPECT_ZERONAME);
    }
    ...
    function testAssertEq_Bool_ZeroName(bool a) external {
        t._assertEq(a, a, EXPECT_ZERONAME);
    }
    ...
    function testAssertEq_BoolErr_ZeroName(bool a) external {
        t._assertEq(a, a, CUSTOM_ERROR, EXPECT_ZERONAME);
    }
    ...
    function testAssertEq_Bytes_ZeroName(bytes calldata a) external {
        t._assertEq(a, a, EXPECT_ZERONAME);
    }
    ...
    function testAssertEq_BytesErr_ZeroName(bytes calldata a) external {
        t._assertEq(a, a, CUSTOM_ERROR, EXPECT_ZERONAME);
    }
    ...
    function testAssertEq_UintArr_ZeroName(uint256 e0, uint256 e1, uint256 e2) public {
        ...
        t._assertEq(a, b, EXPECT_ZERONAME);
    }

    function testAssertEq_IntArr_ZeroName(int256 e0, int256 e1, int256 e2) public {
    ...
    function testAssertEq_AddressArr_ZeroName(address e0, address e1, address e2) public {
    ...
    function testAssertApproxEqAbs_Uint_ZeroName(uint256 a, uint256 b, uint256 maxDelta) external {
        vm.assume(stdMath.delta(a, b) <= maxDelta);

        t._assertApproxEqAbs(a, b, maxDelta, EXPECT_ZERONAME);
    }
    ...
    function testAssertApproxEqAbs_UintErr_ZeroName(uint256 a, uint256 b, uint256 maxDelta) external {
        vm.assume(stdMath.delta(a, b) <= maxDelta);

        t._assertApproxEqAbs(a, b, maxDelta, CUSTOM_ERROR, EXPECT_ZERONAME);
    }
    ...
    function testAssertApproxEqAbs_Int_ZeroName(int256 a, int256 b, uint256 maxDelta) external {
        vm.assume(stdMath.delta(a, b) <= maxDelta);
    ...
    function testAssertApproxEqAbs_IntErr_ZeroName(int256 a, int256 b, uint256 maxDelta) external {
        vm.assume(stdMath.delta(a, b) <= maxDelta);
    ...
    function testAssertApproxEqRel_Uint_ZeroName(uint256 a, uint256 b, uint256 maxPercentDelta) external {
        vm.assume(a < type(uint128).max && b < type(uint128).max && b != 0);
        vm.assume(stdMath.percentDelta(a, b) <= maxPercentDelta);

        t._assertApproxEqRel(a, b, maxPercentDelta, EXPECT_ZERONAME);
    }
    ...
    function testAssertApproxEqRel_UintErr_ZeroName(uint256 a, uint256 b, uint256 maxPercentDelta) external {
        vm.assume(a < type(uint128).max && b < type(uint128).max && b != 0);
        vm.assume(stdMath.percentDelta(a, b) <= maxPercentDelta);

        t._assertApproxEqRel(a, b, maxPercentDelta, CUSTOM_ERROR, EXPECT_ZERONAME);
    }
    ...
    function testAssertApproxEqRel_Int_ZeroName(int128 a, int128 b, uint128 maxPercentDelta) external {
        vm.assume(b != 0);
        vm.assume(stdMath.percentDelta(a, b) <= maxPercentDelta);
    ...
    function testAssertApproxEqRel_IntErr_ZeroName(int128 a, int128 b, uint128 maxPercentDelta) external {
        vm.assume(b != 0);
        vm.assume(stdMath.percentDelta(a, b) <= maxPercentDelta);
