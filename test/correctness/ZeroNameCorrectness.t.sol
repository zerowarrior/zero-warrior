...
contract ZeroNameCorrectnessTest is DSTestPlus {
    ...
    function setUp() public {
        zeroname = new ZeroName(block.timestamp, Zero(address(0)), address(0), ZeroWarrior(address(0)), "");
    ...
    function testFFICorrectness(uint256 timeSinceStart, uint256 numSold) public {
        ...
        try zeroname.getVRGDAPrice(toDaysWadUnsafe(timeSinceStart), numSold) returns (uint256 actualPrice) {
