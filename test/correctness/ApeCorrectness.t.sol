...
contract WarriorCorrectnessTest is DSTestPlus {
    ...
    function setUp() public {
        ...
        MAX_MINTABLE = warrior.MAX_MINTABLE();
    ...
    function testFFICorrectness(uint256 timeSinceStart, uint256 numSold) public {
        ...
        try warrior.getVRGDAPrice(toDaysWadUnsafe(timeSinceStart), numSold) returns (uint256 actualPrice) {
