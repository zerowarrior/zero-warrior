...
contract MockZeroCalculator {
    using FixedPointMathLib for uint256;

    /// @notice Compute zero balance based on emission multiple, last balance, and days elapsed.
    /// @dev Must be kept up to date with the zeroBalance function's corresponding emission balance calculations in ZeroWarrior.sol.
    /// @dev Forked from https://github.com/artape/art-ape/blob/2f19bc901ed2f1bfedeb6f113b073bfc3585386a/src/ZeroWarrior.sol#L693-L708
